{-
  ...
  Repo:       https://github.com/ktoso/xmonad-conf
  Based on    David Brewer's https://github.com/davidbrewer/xmonad-ubuntu-conf
-}
...
keysToRemove x =
    [ 
    ((modMask x .|. controlMask, xK_space ), return ())
    ]
...
myManagementHooks = [
  ...
  , (className =? "Empathy") --> doF (W.shift "7:IM")
  , (className =? "vmware") --> doF (W.shift "0:VM")
  , (className =? "Pidgin") --> doF (W.shift "7:IM")
  , (className =? "Gimp-2.8") --> doF (W.shift "9:Pix")
  , (className =? "Amarok") --> doF (W.shift "9:Pix")
  , (className =? "google-chrome") --> doF (W.shift "6:Web")
  , (className =? "Skype") --> doF (W.shift "7:IM")
  ]
